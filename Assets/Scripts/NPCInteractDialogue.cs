...
{ public GameObject d_template;
    ...
    [Header("Text")]
    public TextMeshProUGUI text2TMP;

    // TextMeshPro for dialogue
    ...
    // Reference to the FPCharacterController script
    private bool optionsDisplayed;
    public bool player_detection;

    [Header("Game Objects")]
    public GameObject Vase;
    public GameObject GuyThorpe;
    public GameObject GuyThorpe2; 
    void Start()
    ...
    { if (Input.GetKeyDown(KeyCode.E) && player_detection)
        {
            // Enable cursor and show dialogue
            Cursor.lockState = CursorLockMode.None;
            Cursor.visible = true;
            ...
            spritePlacement++; // Disable player movement and rotation while dialogue is active
    ...
    { string currentText = Dialogue[placement]; // Get the dialogue text for the current placement
        ...
        while (textIndex < currentText.Length) { displayedText += currentText[textIndex];
            text2TMP.text = displayedText; textIndex++;
        ...
        if (Dialogue[placement].Contains("Are there any other people living in this manor?"))
        {
            ExtraSprite.SetActive(false);
            neutralSprite.SetActive(false);
            happySprite.SetActive(false);
        ...
        if (Dialogue[placement].Contains("My butler, who is away on a business trip on my behalf at the moment.I do also have maids coming in, but only on the weekends."))
        {
            ExtraSprite.SetActive(false);
            neutralSprite.SetActive(false);
            happySprite.SetActive(false);
        ...
        } if (Dialogue[placement].Contains("(judging) We made sure to prioritise you Sir, since you sounded quite worried."))
        {
            ExtraSprite.SetActive(false);
            neutralSprite.SetActive(false);
            happySprite.SetActive(false);
        ...
        if (Dialogue[placement].Contains("I appreciate it. Now, let me show you to where the accident happened. "))
        {
            ExtraSprite.SetActive(false);
            neutralSprite.SetActive(false);
            happySprite.SetActive(false);
        ...
        if (Dialogue[placement].Contains("(smiling) Since it was quite late, I called your firm in the morning. I apologise for the short notice, but I assume you weren’t too overwhelmed with other work."))
        ...
        if (Dialogue[placement].Contains("Does anyone come to mind that could have targeted you, or something you own?"))
        {
            ExtraSprite.SetActive(false);
            neutralSprite.SetActive(false);
            happySprite.SetActive(false);
        ...
        if (Dialogue[placement].Contains("Not at all. I have it taken out regularly on walks with my dog walker, and they were out when this occurred."))
        {
            ExtraSprite.SetActive(false);
            neutralSprite.SetActive(false);
            happySprite.SetActive(false);
        ...
        if (Dialogue[placement].Contains("The file mentions you own a dog. Could it have been the cause?"))
        {
            ExtraSprite.SetActive(false);
            neutralSprite.SetActive(false);
            happySprite.SetActive(false);
        ...
        if (Dialogue[placement].Contains("It happened last evening, when I heard a shattering sound. It startled me, and when I went upstairs to check the foyer, the vase was in pieces."))
        {
            ExtraSprite.SetActive(false);
            neutralSprite.SetActive(false);
            happySprite.SetActive(false);
        ...
        if (Dialogue[placement].Contains(" (surprised) It is my first time inside a mansion this big."))
        {
            neutralSpriteFadeIn.SetActive(false);
            neutralDoloresSpriteFadeIn.SetActive(true);
            Cursor.visible = true; } // Increment placement if not currently typing options
    ...
    { text3TMP.text = Name[Name2];
        ...
        { text3TMP.text = Name[Name2];
            neutralSpriteFadeIn.SetActive(true);
            Name2 = 2; Debug.Log("Change Name"); }

        if (Dialogue[placement].Contains("(smiling) You have finally arrived! I have been waiting for you."))
        { text3TMP.text = Name[Name2];
            neutralSpriteFadeIn.SetActive(true);
            Name2 = 1; Debug.Log("Change Name");
        }

        if (Dialogue[placement].Contains("This is my apprentice, Jaxson."))
        { text3TMP.text = Name[Name2];
            neutralSpriteFadeIn.SetActive(true);
            Name2 = 0; Debug.Log("Change Name");
        }
    ...
    { switch (option)
        { case 1: Debug.Log("Option 1 selected");
                placement++;
                break;

            case 2: Debug.Log("Option 2 selected");
                placement++;
                break;

            case 3: Debug.Log("Option 3 selected");
                placement++;
                break;
            default:
                break; } // Hide options panel after selecting an option
                         //
        optionsPanel.SetActive(false);
